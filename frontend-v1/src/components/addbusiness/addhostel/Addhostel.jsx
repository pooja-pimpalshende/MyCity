...
function AddHostel() {
  ...
  //base end point url
  const FILE_UPLOAD_BASE_ENDPOINT = "http://localhost:8081/hostel";
    ...
    <div className="card">
      <div className="form">
        <form className="addbusinessform">
          <br />
          <h2 className="card-header text-center">Add-Hostel</h2>
          <br />
          ...
          <div className="row">
            ...
            <div className="form-inputs col-5">
              ...
              <input type="text" disabled placeholder="Add Hostel" />
            </div>

            <div className="form-inputs col-5">
              <label htmlFor="orgname" className="form-label">Hostel name:</label>
              <input id="orgname" type="text" name="orgname" placeholder="Enter hostel name"
          ...
          <div className="row">
            ...
            <div className="col-8" style={{ display: 'flex', justifyContent: 'center' }}>
              <button className="form-input-btn" style={{ width: '160px', height: '50px' }} type="submit" onClick={handleSubmit} >Add Hostel</button>
            </div>
