...
function AddCollege() {
  ...
  //base end point url
  const FILE_UPLOAD_BASE_ENDPOINT = "http://localhost:8081/college";
        ...
        <form className="addbusinessform">
          ...
          <div className="card-body row">
            ...
            <div className="form-inputs col-5">
              ...
              <input type="text" disabled placeholder="Add College" />
            </div>
            <div className="form-inputs col-5">
              <label htmlFor="orgname" className="form-label">
                College name:
...
// // AddBusiness method for taking input from user
// function AddCollege() {
//   const { handleChange, values, handleSubmit, errors, uploadFileHandler, fileSize, fileUploadProgress, fileUploadResponse } = useForm(validate);
//   return (
//     <div className="form">
...
//           <div className="form-inputs col-5">
//             <label htmlFor="orgname" className="form-label">College name:</label>
//             <input id="orgname" type="text" name="orgname" placeholder="Enter college name"
...
//         <button className="form-input-btn" type="submit" onClick={handleSubmit}>Add College</button>
//       </form>
//     </div>
//   );
// }
