...
@Table(name = "coaching") 
//uniqueConstraints = { 
//  @UniqueConstraint(columnNames = "coaching_name"),
...
//	@Length(min =6, max=6, message = "Invalid pincode length!!!!")
	...
	public Coaching(long id, String coaching_name, long phone_no, String email, String street, String city,
	...
	public String toString() {
		return "Coaching [id=" + id + ", coaching_name=" + coaching_name + ", phone_no=" + phone_no + ", email=" + email
